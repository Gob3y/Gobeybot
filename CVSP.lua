...
-- ============================================================
-- CONTENT AREA (dengan Scroll, tidak clip agar dropdown tidak terpotong)
-- ============================================================
local Content = Instance.new("Frame")
Content.Size = UDim2.new(1, -8, 1, -92)
Content.Position = UDim2.new(0, 4, 0, 86)
...
-- ============================================================
-- FUNGSI UI ELEMEN (dengan ukuran lebih besar untuk Android)
-- ============================================================
...
local function addDropdown(page, label, options, default, callback)
    ...
    -- Dropdown list (muncul di atas semua)
    ...
    -- Frame container untuk dropdown agar tidak terpotong oleh scroll frame (ZIndex lebih tinggi)
...
print("Auto Farm GUI versi responsif siap! Ukuran menyesuaikan layar Android.")